...
def predict():
    ...
    # prior prediction is predict_bert
    predictions = vtg.make_final_prediction(predict_bert, predict_svc, predict_lstm_gru_cnn_glove)
    dataset["Category"] = predictions
    predictions_csv = dataset[["Id", "Category"]]
    predictions_csv.to_csv("./final_prediction.csv", index=False)
